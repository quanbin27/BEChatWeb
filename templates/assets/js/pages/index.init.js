...
function searchUser() {
    const userLi = document.querySelectorAll('#favourite-users li');
    const groupLi = document.querySelectorAll('#favourite-groups li');
    input = document.getElementById("serachChatUser")
    filter = input.value.toUpperCase();
    for(i =0; i< userLi.length; i++){
        if(userLi[i].querySelector('.username').innerText.toUpperCase().indexOf(filter)>-1){
    ...
    for(i =0; i < groupLi.length; i++){
        if(groupLi[i].querySelector('.groupname').innerText.toUpperCase().indexOf(filter)>-1){
            groupLi[i].style.display = ''
        }
        else
...
function searchContacts() {
    ...
    for (i = 0;  i< li.length; i++) {
        contactName = li[i]
        txtValue = contactName.querySelector('.name').innerText;
  ...
  document.querySelectorAll(".theme-img , .theme-color").forEach(function (o) {
    ...
    n &&
      ...
      o.addEventListener("click", function (e) {
        ...
        var l,
          n,
          r = document.querySelector("input[name=bgimg-radio]:checked");
        r &&
          ((r = r.id),
          window.localStorage.setItem("image", r),
    ...
    null !== e
      ...
      : (t[0].favorites.forEach(function (e, t) {
          var a = e.profile
            ...
            s = e.messagecount
              ? '<div class="ms-auto"><span class="badge bg-dark-subtle text-reset rounded p-1">' +
                e.messagecount +
                "</span></div>"
              : "",
            i = e.messagecount
        ...
        t[0].channels.forEach(function (e, t) {
          var a = e.messagecount
              ? '<div class="flex-shrink-0 ms-2"><span class="badge bg-dark-subtle text-reset rounded p-1">' +
                e.messagecount +
                "</span></div>"
              : "",
            s = e.messagecount
          ...
          document.getElementById("channelList").innerHTML +=
            ...
            '" data-name="channel">                ' +
            s +
            '                     <div class="d-flex align-items-center">                        <div class="flex-shrink-0 avatar-xs me-2">                            <span class="avatar-title rounded-circle bg-light-subtle text-reset">#</span>                        </div>                        <div class="flex-grow-1 overflow-hidden">                            <p class="text-truncate mb-0">' +
            e.name +
            "</p>                        </div>                        <div>" +
            a +
            "</div>                        </div>                </a>            </li>";
      ...
      e.readAsDataURL(o),
        ...
        e.addEventListener(
          ...
          function () {
            ...
            (a.innerHTML =
              '<div class="card p-2 border mb-2 audiofile_pre d-inline-block position-relative">            <div class="d-flex align-items-center">                <div class="flex-shrink-0 avatar-xs ms-1 me-3">                    <div class="avatar-title bg-primary-subtle text-primary rounded-circle">                        <i class="bx bx-headphone"></i>                    </div>                </div>                <div class="flex-grow-1 overflow-hidden">                <h5 class="font-size-14 text-truncate mb-1">' +
              e +
      ...
      (c = document.querySelector("#attachedfile-input").files[0]),
        ...
        fr.addEventListener(
          ...
          function () {
            ...
            (a.innerHTML =
              '<div class="card p-2 border attchedfile_pre d-inline-block position-relative">            <div class="d-flex align-items-center">                <div class="flex-shrink-0 avatar-xs ms-1 me-3">                    <div class="avatar-title bg-primary-subtle text-primary rounded-circle">                        <i class="ri-attachment-2"></i>                    </div>                </div>                <div class="flex-grow-1 overflow-hidden">                <a href="" id="a"></a>                    <h5 class="font-size-14 text-truncate mb-1">' +
              e +
        ...
        ? (function (e, t, a) {
            ...
            null != t &&
              s.insertAdjacentHTML(
                ...
                '<li class="chat-list right" id="chat-list-' +
                  w +
                  '" >          <div class="conversation-list">              <div class="user-chat-content">                  <div class="ctext-wrap">                      <div class="ctext-wrap-content">                          <div class="p-3 border-primary border rounded-3">                              <div class="d-flex align-items-center attached-file">                                  <div class="flex-shrink-0 avatar-sm me-3 ms-0 attached-file-avatar">                                      <div class="avatar-title bg-primary-subtle text-primary rounded-circle font-size-20"><i class="ri-attachment-2"></i></div>                                  </div>                                  <div class="flex-grow-1 overflow-hidden">                                      <div class="text-start">                                          <h5 class="font-size-14 mb-1">' +
                  t +
        ...
        ? (function (e, t, a) {
            ...
            null != t &&
              s.insertAdjacentHTML(
                ...
                '<li class="chat-list right" id="chat-list-' +
                  w +
                  '" >          <div class="conversation-list">              <div class="user-chat-content">                  <div class="ctext-wrap">                      <div class="ctext-wrap-content">                          <div class="p-3 border-primary border rounded-3">                              <div class="d-flex align-items-center attached-file">                                  <div class="flex-shrink-0 avatar-sm me-3 ms-0 attached-file-avatar">                                      <div class="avatar-title bg-primary-subtle text-primary rounded-circle font-size-20"><i class="bx bx-headphone"></i></div>                                  </div>                                  <div class="flex-grow-1 overflow-hidden">                                      <div class="text-start">                                          <h5 class="font-size-14 mb-1">' +
                  t +
                  '</h5>                                          <p class="text-muted text-truncate font-size-13 mb-0">' +
                  a +
    ...
    (t = e),
      (a = function (e, t) {
        ...
        null !== e
          ...
          (r = document.querySelector("#close_toggle")),
          ...
          (o = document.querySelector(".replyCard")),
